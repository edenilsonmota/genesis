...
- A categoria **Financeiro** é expansível, guarda a preferência em `genesis.sidebar.finance.open` e exibe somente **Contas e categorias** enquanto as demais telas do módulo não estiverem implementadas.
