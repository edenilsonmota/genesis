...
class UpdateChurchRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $church instanceof Church && ($this->user()?->can('update', $church) ?? false);
    }
    ...
    public function after(): array
    {
        return [
            function (Validator $validator): void {
                ...
                if ($area !== null && $church instanceof Church && ! $validator->errors()->has('name') && Church::query()
                    ->whereBelongsTo($area)
                    ->whereKeyNot($church->getKey())
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'status' => $this->input('status', ($this->route('church') instanceof Church ? $this->route('church')->status->value : Status::Active->value)),
        ]);
    }
}
