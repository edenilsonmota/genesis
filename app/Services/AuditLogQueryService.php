...
class AuditLogQueryService
{
    ...
    private const ACTION_LABELS = [
        ...
        'member_import.blank_template_generated' => 'Modelo de importação gerado',
        'member_import.update_template_exported' => 'Membros exportados para atualização',
        'member_import.uploaded' => 'Arquivo de membros enviado',
        'member_import.validation_started' => 'Validação da importação iniciada',
        'member_import.validation_completed' => 'Validação da importação concluída',
        'member_import.validation_failed' => 'Importação reprovada na validação',
        'member_import.confirmed' => 'Importação confirmada',
        'member_import.confirmation_blocked' => 'Confirmação da importação bloqueada',
        'member_import.processing_started' => 'Processamento da importação iniciado',
        'member_import.processing_completed' => 'Importação de membros concluída',
        'member_import.processing_failed' => 'Processamento da importação falhou',
        'member_import.technical_failure' => 'Falha técnica na importação',
    ...
    private const RESOURCE_LABELS = [
        ...
        'churches' => 'Igreja',
        'members' => 'Membro',
        'member_imports' => 'Importação de membros',
